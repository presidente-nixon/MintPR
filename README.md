...
### License
Multiprocessing for FFmpeg interpolation is under the MIT license. Just be 100% aware that I am only 14 years old at the time of writing this and I am no where near to being a lawyer, so if the MIT license conflicts with the LGPLv2.1 license of FFmpeg, please let me know, hopefully though if it does, it doesn't grab to much attention to FFmpeg since I am not selling this "product" for money.
### Contributing
